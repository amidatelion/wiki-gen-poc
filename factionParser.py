...
def recurse_into_itemCollection(item_name, search_dirs):
...
""" def parseFactionTree(item_name, search_dirs):
...
def process_Faction_Collection(file_path, search_dirs):
    ...
    try:
        with open(file_path, "r") as json_file:
            ...
            if item_name.startswith("itemCollection"):
                matched_entries.update(recurse_into_itemCollection(item_name, search_dirs))
